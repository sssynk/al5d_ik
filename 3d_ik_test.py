...
from al5dpy import al5_3D_IK, al5_moveMotors
...
while cont:
	...
	targetXYZGWAWR = (targetXYZGWAWR[0], targetXYZGWAWR[1], targetZ, targetXYZGWAWR[3], targetXYZGWAWR[4], targetXYZGWAWR[5])

	# Perform IK
	errorValue = al5_3D_IK(targetXYZGWAWR)
